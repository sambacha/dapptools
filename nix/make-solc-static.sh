...
linux_urls="$(jq <linux.json -r '.builds[] | "https://binaries.soliditylang.org/linux-amd64/\(.path)"')"
macos_urls="$(jq <macos.json -r '.builds[] | "https://binaries.soliditylang.org/macosx-amd64/\(.path)"')"
